...
```
The current supported encryptions are hex, base64, and  <a href="https://github.com/MrSharkSpamBot/CadaverousCipher">CadaverousCipher</a>. To use CadaverousCipher, generate a dictionary as shown its github page and save the dictionary to the file dictionary_key.json. To send data with newline characters use the command multiline.
