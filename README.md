...
```
The current supported encryptions are hex, base64, and  <a href="https://github.com/MrSharkSpamBot/CadaverousCipher">CadaverousCipher</a>. To send data with newline characters use the command multiline.
